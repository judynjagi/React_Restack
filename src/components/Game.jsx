...
import { Stars, Answer, SubmitButton, Numbers, DoneFrame } from "Components";
...
export class Game extends React.Component {
  ...
  selectNumber = selectedNumber => {
    ...
    if (
      usedNumbers.indexOf(selectedNumber) >= 0 ||
      selectedNumbers.indexOf(selectedNumber) >= 0
    ) {
      return;
    }
  ...
  checkCorrectAnswer = () => {
    this.setState(prevState => ({
      answerIsCorrect:
        ...
        prevState.selectedNumbers.reduce((acc, value) => acc + value, 0)
    }));
  };
